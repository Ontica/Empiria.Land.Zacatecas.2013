...
<tr class="<%# ((int) DataBinder.Eval(Container, "ItemIndex") % 2 == 0 ? String.Empty  : "oddDataRow") %>" onmouseover="dataGridRowSelect(this, true);" onmouseout="dataGridRowSelect(this, false);">
    ...
    <a href="javascript:doOperation('showRecording', <%#DataBinder.Eval(Container, "DataItem.RecordingBookId")%>, <%#DataBinder.Eval(Container, "DataItem.RecordingId")%>)" class="detailsLinkTitle"><%#DataBinder.Eval(Container, "DataItem.PropertyTractKey")%></a> 
