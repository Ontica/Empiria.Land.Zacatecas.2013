...
<%# ((int) DataBinder.Eval(Container, "ItemIndex")) % 3 == 0 ? "<tr class='" + ((int) DataBinder.Eval(Container, "ItemIndex") % 2 == 0 ? String.Empty  : "oddDataRow") + "' onmouseover='dataGridRowSelect(this, true);' onmouseout='dataGridRowSelect(this, false);'>" : String.Empty %> 
	<td style="white-space:nowrap;">
		<table class="ghostTable" width="30%">
			...
			<tr><td>Sección:</td><td><span class='boldItem'><%#DataBinder.Eval(Container, "DataItem.ParentRecordingBookTag")%>&nbsp; &nbsp; &nbsp;</span></td><td>Inscripciones:&nbsp;&nbsp;</td><td style="width:100%"><span class='boldItem'><%#((int)DataBinder.Eval(Container, "DataItem.RecordingsControlCount")).ToString("N0")%></span></td></tr>
      <tr><td>Volumen:</td><td><span class='boldItem'><%#DataBinder.Eval(Container, "DataItem.RecordingBookNumber")%></span></td><td style="white-space:nowrap;">Fecha inicial:</td><td style="width:100%"><span class='boldItem'><%#(EmpiriaString.DateTimeString((DateTime)DataBinder.Eval(Container, "DataItem.RecordingsControlFirstDate")))%></span></td></tr>
			<tr><td>&nbsp; &nbsp;</td><td>&nbsp;</td><td style="white-space:nowrap;">Fecha final:&nbsp;&nbsp;</td><td style="width:100%"><span class='boldItem'><%#(EmpiriaString.DateTimeString((DateTime)DataBinder.Eval(Container, "DataItem.RecordingsControlLastDate")))%></span>&nbsp;&nbsp;</td></tr>
		</table>
	</td>
