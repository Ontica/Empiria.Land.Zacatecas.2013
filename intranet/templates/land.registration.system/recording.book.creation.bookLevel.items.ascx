...
<tr class="<%# ((int) DataBinder.Eval(Container, "ItemIndex") % 2 == 0 ? String.Empty  : "oddDataRow") %>" onmouseover="dataGridRowSelect(this, true);" onmouseout="dataGridRowSelect(this, false);">
    ...
    Libro: <span id="lblBookName<%#DataBinder.Eval(Container, "DataItem.FilesFolderId")%>" class='boldItem'><%#EmpiriaString.GetSection((string) DataBinder.Eval(Container, "DataItem.FilesFolderDisplayName"), '-', 2)%></span> &nbsp; &nbsp;
		Volumen: <span id="lblVolumeName<%#DataBinder.Eval(Container, "DataItem.FilesFolderId")%>" class='boldItem'><%#EmpiriaString.GetSection((string) DataBinder.Eval(Container, "DataItem.FilesFolderDisplayName"), '-', 3)%></span>&nbsp;&nbsp;<br /><br />
		Digitalizado por: 
