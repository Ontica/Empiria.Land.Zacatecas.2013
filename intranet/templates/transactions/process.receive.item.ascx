...
<tr class="<%# ((int) DataBinder.Eval(Container, "ItemIndex") % 2 == 0 ? String.Empty  : "oddDataRow") %>" onmouseover="dataGridRowSelect(this, true);" onmouseout="dataGridRowSelect(this, false);">
    ...
    <br />
    <input class="button" type="button" value="Recibir documentación" onclick="doOperation('takeLRSTransaction', <%# DataBinder.Eval(Container, "DataItem.TransactionId")%>)" style="width:136px;height:34px" />
	</td>
</tr>
