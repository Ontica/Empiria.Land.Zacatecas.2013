...
<tr class="<%# ((int) DataBinder.Eval(Container, "ItemIndex") % 2 == 0 ? String.Empty  : "oddDataRow") %>" onmouseover="dataGridRowSelect(this, true);" onmouseout="dataGridRowSelect(this, false);">
	...
	<td style="white-space:nowrap;width:30%">
      ...
      <tr><td style="width:20px">Precalificación:&nbsp;</td><td><span class='boldItem'><%#((DateTime)DataBinder.Eval(Container, "DataItem.PostingTime")).ToString("dd/MMM/yyyy HH:mm")%></span></td></tr>
