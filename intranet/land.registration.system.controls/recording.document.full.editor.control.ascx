<%@ Control Language="C#" AutoEventWireup="false" EnableViewState="true" Inherits="Empiria.Web.UI.LRS.RecordingDocumentFullEditorControl" Codebehind="recording.document.full.editor.control.ascx.cs" %>
  ...
  <tr>
    ...
    <td>
      <select id="cboJudicialDocSubtype" class="selectBox" style="width:160px" title="" runat="server">
		...
		<!--
							<option value='770'>Embargo judicial</option>
				<option value='771'>Embargo administrativo</option>
		!-->
    </td>
		<td>
      Expediente: &nbsp;
  ...
  <tr>
    ...
    <td>
      <select id="cboPrivateDocSubtype" class="selectBox" style="width:160px" title="" runat="server">
				<option value=''>( Seleccionar )</option>
				<option value='775'>Contrato traslativo de dominio</option>
				<option value='774'>Contrato hipotecario</option>
				<option value='773'>Fianza</option>
			</select>
    </td>
		<td>
			Núm de contrato:
