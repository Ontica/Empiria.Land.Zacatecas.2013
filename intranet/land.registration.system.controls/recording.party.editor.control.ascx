<%@ Control Language="C#" AutoEventWireup="false" Inherits="Empiria.Web.UI.LRS.RecordingPartyEditorControl" Codebehind="recording.party.editor.control.ascx.cs" %>
  ...
  <tr>
    ...
    <td class="lastCell separator">
      ...
      <select id="cboOrgRegistryLocation" class="selectBox" style="width:165px" title="" onchange="return updateUserInterface();" runat="server">
        ...
        <option value='101'>Aguascalientes</option>
        <option value='102'>Baja California</option>
        <option value='103'>Baja California Sur</option>
        <option value='104'>Campeche</option>
        <option value='105'>Chiapas</option>
        <option value='106'>Chihuahua</option>
        <option value='107'>Coahuila</option>
        <option value='108'>Colima</option>
        <option value='109'>Distrito Federal</option>
        <option value='110'>Durango</option>
        <option value='111'>Guanajuato</option>
        <option value='112'>Guerrero</option>
        <option value='113'>Hidalgo</option>
        <option value='114'>Jalisco</option>
        <option value='115'>México</option>
        <option value='116'>Michoacán</option>
        <option value='117'>Morelos</option>
        <option value='118'>Nayarit</option>
        <option value='119'>Nuevo León</option>
        <option value='120'>Oaxaca</option>
        <option value='121'>Puebla</option>
        <option value='122'>Querétaro</option>
        <option value='123'>Quintana Roo</option>
        <option value='124'>San Luis Potosí</option>
        <option value='125'>Sinaloa</option>
        <option value='126'>Sonora</option>
        <option value='127'>Tabasco</option>
        <option value='128'>Tamaulipas</option>
        <option value='129'>Tlaxcala</option>
        <option value='130'>Veracruz</option>
        <option value='131'>Yucatán</option>
        <option value='132'>Zacatecas</option>
			</select>
		</td>
	</tr>
</table>
          ...
          <td>
            ...
            <div id="divDomainRole" style="display:none;">
              ...
              <select id="cboOwnership" class="selectBox" style="width:122px" title="" onchange="return this_updateUserInterface(this);" runat="server">
			          <option value="">( Seleccionar )</option>
                <option value="Owner">Propietario único</option>
                <option value="Coowner">Copropietario</option>
                <option value="Bare">Nudo propietario</option>
		          </select>
              Parte:
