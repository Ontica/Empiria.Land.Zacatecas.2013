<%@ Control Language="C#" AutoEventWireup="false" Inherits="Empiria.Web.UI.LRS.RecordingActAttributesEditorControl" Codebehind="recording.act.attributes.editor.control.ascx.cs" %>
