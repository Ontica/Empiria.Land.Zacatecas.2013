<%@ Page Language="C#" EnableViewState="true" AutoEventWireup="true" Inherits="Empiria.Web.UI.LRS.RecordingBookSearcher" Codebehind="integrated.searcher.aspx.cs" %>
    ...
    <div id="divBody">
      <div id="divContent">
        <table cellpadding="0" cellspacing="0">
          <tr>
            <td id="divSearchSection" valign="top" style="width:600px; background-color:Blue ">
              <table class="tabStrip">
                <tr>
                  <td id="Td1" class="tabOn" onmouseover="doCommand('onMouseOverTabStripCmd', this);" onmouseout="doCommand('onMouseOutTabStripCmd', this);"  onclick="doCommand('onClickTabStripCmd', this);" title="">Buscar personas</td>
                  <td id="Td2" class="tabOff" onmouseover="doCommand('onMouseOverTabStripCmd', this);" onmouseout="doCommand('onMouseOutTabStripCmd', this);" onclick="doCommand('onClickTabStripCmd', this);" title="">Predios</td>
                  <td id="Td3" class="tabOff" onmouseover="doCommand('onMouseOverTabStripCmd', this);" onmouseout="doCommand('onMouseOutTabStripCmd', this);" onclick="doCommand('onClickTabStripCmd', this);" title="">Inscripciones</td>
                  <td id="Td4" class="tabOff" onmouseover="doCommand('onMouseOverTabStripCmd', this);" onmouseout="doCommand('onMouseOutTabStripCmd', this);" onclick="doCommand('onClickTabStripCmd', this);" title="">Certificados</td>
                  <td id="Td5" class="tabOff" onmouseover="doCommand('onMouseOverTabStripCmd', this);" onmouseout="doCommand('onMouseOutTabStripCmd', this);" onclick="doCommand('onClickTabStripCmd', this);" title="">Libros</td>
            ...
            <td id="divDocumentViewer" valign="top" style="width:670px;">
              <table class="tabStrip">
                <tr>
                  <td id="tabStripItem_0" class="tabOn" onmouseover="doCommand('onMouseOverTabStripCmd', this);" onmouseout="doCommand('onMouseOutTabStripCmd', this);"  onclick="doCommand('onClickTabStripCmd', this);" title="">Información registrada</td>
                  <td id="tabStripItem_1" class="tabOff" onmouseover="doCommand('onMouseOverTabStripCmd', this);" onmouseout="doCommand('onMouseOutTabStripCmd', this);" onclick="doCommand('onClickTabStripCmd', this);" title="">Documentos e imágenes</td>
                  <td id="tabStripItem_2" class="tabOff" onmouseover="doCommand('onMouseOverTabStripCmd', this);" onmouseout="doCommand('onMouseOutTabStripCmd', this);" onclick="doCommand('onClickTabStripCmd', this);" title="">Ubicación geográfica</td>
                  <td id="tabStripItem_3" class="tabOff" onmouseover="doCommand('onMouseOverTabStripCmd', this);" onmouseout="doCommand('onMouseOutTabStripCmd', this);" onclick="doCommand('onClickTabStripCmd', this);" title="">Información catastral</td>
            ...
            <table id="tabStripItemView_0" class="editionTable" style="display:inline;">
              ...
              <tr>
                <td>
                  ...
                  <tr>
                    ...
                    <td>
                      <input id="txtRecordingNumber" type="text" class="textBox" style="width:32px;margin-right:0px" onkeypress="return integerKeyFilter(this);" title="" maxlength="4" runat="server" />
                ...
                <td>
                  <table class="editionTable">
                    ...
                    <tr id="divAnnotationEditorRow3" style="display:none">
                      <td>Número de inscripción:</td>
                      <td>
                        <input id="txtAnnotationNumber" name="txtAnnotationNumber" onkeypress="return integerKeyFilter(this);" type="text" class="textBox" style="width:32px;margin-right:0px" title="" maxlength="8" runat="server" />
              ...
              <tr>
                <td>
                  <table>
                    <tr>
                      <td nowrap='nowrap'>Ir a la inscripción: &nbsp;<input id="txtGoToRecording" name="txtGoToRecording" type="text" class="textBox" maxlength="4" style="width:32px;margin-right:0px" onkeypress="return integerKeyFilter(this);" runat="server" /></td>
                ...
                <td id="divImageViewer" valign='top' style="position:relative">
                  ...
                  <table>                
                    <tr>
                      ...
                      <td nowrap='nowrap'>
                        Ir a la imagen: <input id="txtGoToImage" name="txtGoToImage" type="text" class="textBox" maxlength="4" style="width:32px;margin-right:0px" onkeypress="return integerKeyFilter(this);" runat="server" />
                      </td>
...
<iframe id="ifraCalendar" style="z-index:99;left:0px;visibility:hidden;position:relative;top:0px" 
  ...
  function registerAsIncompleteRecording() {
    ...
    <% if (recording.IsNew) { %>
      ...
      sMsg += "¿Registro la inscripción " + getElement('txtRecordingNumber').value + " como vigente?";
    <% } else { %>
  ...
  function deleteRecording() {	
    ...
    <% if (recordingBook.RecordingsClass.NamedKey != "DomainTraslative") { %>
      alert("No puedo eliminar esta inscripción debido a que se trata de una anotación de otra inscripción.");
      return false;
    <% } %>
    ...
    sMsg += "Libro:\t\t<%=recordingBook.FullName%>\n";
    sMsg += "Inscripción:\t" + getElement('txtRecordingNumber').value + "\n\n";
    sMsg += "¿Elimino la inscripción " + getElement('txtRecordingNumber').value + " de este libro?";		
    if (confirm(sMsg)) {
  ...
  function getAnnotationDataForm() {
    ...
    sMsg += "Número:\t\t" + getElement('txtAnnotationNumber').value;		
...
//  }
  ...
  function window_onscroll() {
    ...
    if (newHeight <= 0) {
      getElement('divSearchSection').style.top = 0;
      getElement('divImageViewer').style.top = 0;
    } else {
      getElement('divImageViewer').style.top = newHeight - 120;
    }
  }
