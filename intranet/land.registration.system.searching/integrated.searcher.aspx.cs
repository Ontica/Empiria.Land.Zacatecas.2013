...
namespace Empiria.Web.UI.LRS {
  ...
  public partial class RecordingBookSearcher : WebPage {
    ...
    private void LoadAnotherPropertyRecorderOfficesCombo() {
      ...
      RecordingActTypeCategory recordingActTypeCategory = RecordingActTypeCategory.Parse(1051);

      ObjectList<RecordingBook> recordingBookList = recordingBook.RecorderOffice.GetRecordingBooks(recordingActTypeCategory);
    ...
    private void Initialize() {
      recordingBook = RecordingBook.Parse(1555);
