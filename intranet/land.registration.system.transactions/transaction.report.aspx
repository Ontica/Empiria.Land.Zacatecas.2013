<%@ Page Language="C#" AutoEventWireup="true" Inherits="Empiria.Web.UI.FSM.TransactionReport" Codebehind="transaction.report.aspx.cs" %>
...
<body topmargin="0">
  <form id="frmEditor" method="post" runat="server">
    <table style="" cellspacing="0" cellpadding="0" width="100%">
      ...
      <!--
      <tr>
        <td align="center" style="border-top: 2px solid #3a3a3a">
          <br /><br /><br /><br /><br /><br /><br />
          <b>Lic. Ma. Esthela Sánchez</b><br />
            Directora<br />&nbsp;
        </td>
      </tr>
      !-->
