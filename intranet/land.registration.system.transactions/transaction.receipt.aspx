<%@ Page Language="C#" AutoEventWireup="true" Inherits="Empiria.Web.UI.FSM.TransactionReceipt" Codebehind="transaction.receipt.aspx.cs" %>
        ...
        <td style="border-top: 3px solid #3a3a3a;padding-top:8pt;padding-bottom:4pt">
          <table style="width:100%;white-space:nowrap" cellpadding="3px" cellspacing="0px">
            ...
            <tr>
              ...
              <td style="white-space:nowrap">Importe:</td><td style="white-space:nowrap;width:30%"><b><%=transaction.ReceiptTotal.ToString("C2")%></b>&nbsp; (R: <b><%=transaction.ReceiptNumber%>)</b></td>
            </tr>
            <tr>
