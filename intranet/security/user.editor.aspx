...
<asp:Content ID="bottomToolbar" ContentPlaceHolderID="bottomToolbarPlaceHolder" Runat="Server">
  ...
  <span class="rightItem nowrap">
    <input id="btnAcceptChanges" name="btnAcceptChanges" type="button" class="button" <%=onChangesButtonAttrs%> disabled="disabled" onclick="doOperation('acceptChangesCmd')" title="Acepta los cambios y cierra la página" style="width: 70px" value="<%=btnAcceptChangesText%>" />
    ...
    <input id="btnApplyChanges" name="btnApplyChanges" type="button" class="button"  <%=onChangesButtonAttrs%> disabled="disabled" onclick="doOperation('applyChangesCmd')" title="Aplica los cambios efectuados y mantiene esta página abierta" style="width: 70px" value="<%=btnApplyChangesText%>" />
  </span>
