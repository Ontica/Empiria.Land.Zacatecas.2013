<%@ Page Language="C#" EnableViewState="true"  EnableSessionState="true" MasterPageFile="~/workplace/dashboard.master" AutoEventWireup="true" Inherits="Empiria.Web.UI.LRSAnalytics.DailyHistoricRecordingDashboard" Codebehind="daily.historic.recording.dashboard.aspx.cs" %>
