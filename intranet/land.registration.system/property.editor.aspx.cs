...
namespace Empiria.Web.UI.LRS {
  ...
  public partial class PropertyEditor : WebPage {
    ...
    private void LoadPropertyControls() {
      txtCadastralNumber.Value = property.CadastralKey;
      txtTractNumber.Value = property.TractKey;
      ...
      txtUbication.Value = property.Ubication;
      txtExternalNumber.Value = property.ExternalNumber;
      txtInternalNumber.Value = property.InternalNumber;
      txtFractionTag.Value = property.FractionTag;
      txtBatchTag.Value = property.BatchTag;
      txtBlockTag.Value = property.BlockTag;
      txtSectionTag.Value = property.SectionTag;
      txtSuperSectionTag.Value = property.SuperSectionTag;
