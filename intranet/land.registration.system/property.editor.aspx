<%@ Page Language="C#" EnableViewState="true" AutoEventWireup="true" Inherits="Empiria.Web.UI.LRS.PropertyEditor" Codebehind="property.editor.aspx.cs" %>
  ...
  <tr>
    <td>
      ...
      <tr>
        ...
        <td>
          <input type="text" class="textBox" id='txtCadastralNumber' name='txtCadastralNumber' onkeypress="return phoneKeyFilter(this);" style="width:140px" maxlength="20" runat='server' title="" />
        ...
        <td class="lastCell">
          <input type="text" class="textBox" id='txtTractNumber' name='txtTractNumber' style="width:100px" readonly='readonly' runat='server' title="" />
          Estado:
