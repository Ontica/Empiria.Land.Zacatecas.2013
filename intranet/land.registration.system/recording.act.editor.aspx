<%@ Page Language="C#" EnableViewState="true" AutoEventWireup="true" Inherits="Empiria.Web.UI.LRS.RecordingActEditor" Codebehind="recording.act.editor.aspx.cs" %>
	  ...
	  <td>
        ...
        <tr>
          ...
          <td class="lastCell" colspan="5">
            <input id="txtRecordingActName" type="text" class="textBox" maxlength="4" style="width:320px;margin-right:0px" readonly="readonly" runat="server" />
            &nbsp; &nbsp;
  			    Aplica a:
				    <select id="cboProperty" class="selectBox" style="width:122px" title="" runat="server">
					  </select>
  			  </td>
  		  </tr>
        <tr id="lastOwnerRow" visible="true" runat="server">
          <td>Propietario anterior:</td>
          <td class="lastCell" colspan="5">
		        <input id='txtFirstPropertyOwner' type="text" class="textBox" style="width:500px;" maxlength="300" runat='server' />
            &nbsp; &nbsp;
          </td>
        </tr>
        <tr>
    ...
    <td>
		  <table class="editionTable">
			<tr>
              ...
              <% if (base.recordingAct.Status != Empiria.Government.LandRegistration.RecordingActStatus.Registered) { %>
...
<script type="text/javascript">
  ...
  function validateRecordingAct() {
    <% if (base.DisplayFirstPropertyOwner) { %>
      if (getElement('txtFirstPropertyOwner').value.length == 0) {
        alert("Requiero conocer el nombre del propietario anterior.");
        return false;
      }
    <% } %>
